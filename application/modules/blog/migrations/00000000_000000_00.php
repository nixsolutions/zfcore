    ...
    public function up()
    {
        ...
        $this->query("
            CREATE TABLE `blog_post` (
              ...
              `status` enum('published','draft','deleted') NOT NULL DEFAULT 'draft' COMMENT 'Defined in Blog_Model_Post',
              ...
              CONSTRAINT `FK_blog_post_categories` FOREIGN KEY (`categoryId`) REFERENCES `categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
