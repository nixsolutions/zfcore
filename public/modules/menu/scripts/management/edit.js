...
function getActions(moduleName,defaultAction) {
        ...
        $.get(
            ...
            function(data) {
                ...
                for (var action in data) {
                    if (defaultAction == data[action]) {
                        html += '<option selected="selected" label="' + data[action] + '" value="' + data[action] + '">' + data[action] + '</option>';
                    } else {
